...
plt.legend()
plt.show()
#Wykresy funkcji e(t) i i(t), wypłąszczyły się i wartości maksymalne są znacznie niższe.
#Przez zmniejszenie wartości beta o połowę, znacznie zmniejszyła się liczba osób wystawionych na działąnie wirusa oraz liczba chorych w piku epidemi.
